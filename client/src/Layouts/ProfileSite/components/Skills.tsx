  ...
  return (
    ...
    <Section ref={element} id="skills">
      ...
      <div className="background">
        <img alt="skills design" className="design1" src={skills1} />
        <img alt="skills design" className="design2" src={skills2} />
      </div>
      ...
      <div className="skills">
        ...
        <div className="skills__content">
          <p className="title">Lorem ipsum dolor, sit amet consectetur impedit?</p>
          <p className="description">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis eius cupiditate incidunt
            distinctio velit quos dolore, ut, tempore suscipit impedit reiciendis voluptas, illo
